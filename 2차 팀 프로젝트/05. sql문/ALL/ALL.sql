...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'GK', '리 그랜트', '오른발', 193, 83, '잉글랜드', 300, '83/01/27');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'GK', '딘 헨더슨', '오른발', 188, 85, '잉글랜드', 200, '97/03/12');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '필 존스', '오른발', 185, 86, '잉글랜드', 600, '92/02/21');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '해리 매과이어', '오른발', 194, 100, '잉글랜드', 1000, '93/03/05');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '디오고 달롯', '오른발', 184, 78, '포르투갈', 500, '90/03/18');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '루크 쇼', '왼발', 185, 75, '잉글랜드', 800, '95/07/12');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '알렉스 텔레스', '왼발', 181, 67, '브라질', 350, '92/12/15');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '에런 완비사카', '오른발', 183, 72, '잉글랜드', 700, '97/11/26');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '브랜든 윌리엄스', '오른발', 171, 63, '잉글랜드', 250, '00/09/03');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '악셀 튀앙제브', '오른발', 186, 72, '잉글랜드', 100, '97/11/14');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '테덴 멘기', '오른발', 183, 78, '잉글랜드', 100, '02/04/30');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '제시 린가드', '오른발', 175, 65, '잉글랜드', 300, '92/12/15');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '제임스 가너', '오른발', 182, 80, '잉글랜드', 200, '01/03/13');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'FW', '마커스 래시퍼드', '오른발', 180, 70, '잉글랜드', 1200, '97/10/31');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'FW', '메이슨 그린우드', '양발', 181, 70, '잉글랜드', 1000, '01/10/01');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '즈 고메즈', '오른발', 188, 77, '잉글랜드', 800, '97/05/23');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '나다니엘 필립스', '오른발', 190, 84, '잉글랜드', 500, '97/03/21');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'DF', '트렌트 알렉산더아널드', '오른발', 175, 69, '잉글랜드', 1300, '98/10/07');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '제임스 밀너', '오른발', 177, 80, '잉글랜드', 800, '86/01/04');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '나비 케이타', '오른발', 172, 64, '기니', 600, '95/02/10');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '조던 헨더슨', '오른발', 182, 80, '잉글랜드', 600, '90/06/17');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '앨랙스 옥슬레이드 체임벌린', '오른발', 180, 70, '잉글랜드', 500, '93/08/15');
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'MF', '커티스 존스', '오른발', 185, 75, '잉글랜드', 400, '01/01/30');
...
insert into PLAYER values(PLAYER_SEQ.nextval, 'EPL', 'FW', '하비 엘리엇', '양발', 170, 67, '잉글랜드', 500, '03/04/04');
