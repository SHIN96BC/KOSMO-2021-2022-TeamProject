      ...
      <div class="modal-body p-5 pt-0">
        <form name="f" action="../member/mController?message=login" method="post">
          <div class="form-floating mb-3">
            <input type="email" class="form-control rounded-4" id="floatingInput" name="email" placeholder="name@example.com">
          ...
          <button class="w-100 py-2 mb-2 btn btn-outline-secondary rounded-4" type="submit" name="sign" value="signupCheck">
