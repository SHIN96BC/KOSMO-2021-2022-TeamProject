...
insert into FOOD values(FOOD_SEQ.nextval, '쿤도', '얼큰한 국물이 먹고 싶을땐 쿤도 짬뽕라멘',5000,'제주시 화삼로1길17','07089002486',default,default,default,'쿤도.png','쿤도.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '형제갈비', '숯불에 구워서 배달하는 양념갈비 맛집',5000,'제주시 은남4길41','0647487078',default,default,default,'형제갈비.png','형제갈비.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '엄블랑호다', '잔잔히 즐기기에 분위기 좋은~ 그런 곳',5000,'제주시 사장길 15 1층','050431391345',default,default,default,'엄블랑호다.png','엄블랑호다.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '우리양', '참숮으로 구운 최고 품질의 양고기를 맛보세요',5000,'제주시 성신로1길 23,1층','0647442326',default,default,default,'우리양.png','우리양.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '만선바다', '고등어회 전문 제주 향토음식점',5000,'제주시 삼무로1길6','0647426300',default,default,default,'만선바다.png','만선바다.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '도리스', '캐나다에 있는 듯한 제주 세계맥주 끝판왕!',5000,'제주시 삼무로40','0649010755',default,default,default,'도리스.png','도리스.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '양푼왕갈비', '든든한 양푼 왕갈비에, 밥까지 볶아먹으면 예술이쥬',5000,'제주시 선덕로14','050714053663',default,default,default,'양푼왕갈비.png','양푼왕갈비.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '파도국수', '맛, 가성비, 서비스 모두 완벽한 공항근처 신상 맛집',5000,'제주시 신대로15길 2 1층','0647491611',default,default,default,'파도국수.png','파도국수.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '수목원집밥', '집밥이 먹고 싶을땐 여기로 오세요',5000,'제주시 삼무로82 1층','0647424483',default,default,default,'수목원집밥.png','수목원집밥.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '이순애소문난순대국밥', '든든한 양푼 왕갈비에, 밥까지 볶아먹으면 예술이쥬',5000,'제주시 선덕로14','050714053663',default,default,default,'이순애소문난순대국밥.png','이순애소문난순대국밥.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '착한튀김', '유명한 튀김맛집착한튀김',5000,'제주시 진남로6길 20','0647233392',default,default,default,'착한튀김.png','착한튀김.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '우리집밥상', '집밥이 드시고 싶다면 우리집밥상으로 ',5000,'제주시 신대로13길19','0647459252',default,default,default,'우리집밥상.png','우리집밥상.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '석정삼계탕', '토종닭으로 즐기는 진정한 보양식',5000,'제주시 진서로33-3','0647566076',default,default,default,'석정삼계탕.png','석정삼계탕.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '신화조개앤횟집', '여행와서 먹는 조개구이 맛이 제일 최고인 거 알쥬',5000,'제주시 진남로6길3','01043378238',default,default,default,'신화조개앤횟집.png','신화조개앤횟집.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '달빛에구은고등어', '먹으면 입 안에서 고등어가 춤추는 맛 ',5000,'제주시 신대로67','0647487998',default,default,default,'달빛에구은고등어.png','달빛에구은고등어.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '한라산국수', '제주에 이보다 더 값진 갈비 고기국수가 어디 있으랴!',5000,'제주시 진서로33-3','0647566076',default,default,default,'한라산국수.png','한라산국수.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '수까락', '한 곳에서 즐기는 차와 식사의 여유로운 만남',5000,'제주시 한천로33','0647497113',default,default,default,'수까락.png','수까락.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '동진식당', '탐나는 한 그릇 행복을 드립니다.',5000,'제주시 용화로 51-1','0647422226',default,default,default,'동진식당.png','동진식당.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '태양상회', '인싸 인증 필수코스세상 Hip한 갬성 술집',5000,'제주시 중앙로2길 31','050713742268',default,default,default,'태양상회.png','태양상회.png', 1,'맛있어요',5,300,1);
insert into FOOD values(FOOD_SEQ.nextval, '돌하르방밀면', '밀면과 보말칼국수를 함께 즐기고 싶다면 여기로!',5000,'중문관광로331','0647390023',default,default,default,'돌하르방밀면.png','돌하르방밀면.png', 1,'맛있어요',5,300,1);
...
insert into FOOD values(FOOD_SEQ.nextval, '각지불', '시각적 포만감부터 남다른 해물찜',5000,'제주시 조천읍 남조로1751','0647840809',default,default,default,'각지불.png','각지불.png', 1,'맛있어요',5,300,1);
