...
public class ActivityService {
	...
	private ActivityService() {
		dao = new ActivityRepository();
	}
	public static ActivityService getInstance() {
		return instance;
	}
	public ArrayList<Activity> listS(long ps, long cp){
		  long psTemp = -1;
	      long cpTemp = -1;
	...
	public void deleteS(int anum) {
		dao.delete(anum);
	}

	public Activity contentS(int anum) {
		return dao.content(anum);
	}
